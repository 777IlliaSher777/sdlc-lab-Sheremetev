...
Нижче — набір тест-кейсів для перевірки функціональності міні‑чату. Для кожного тесту вказано: мета, вхідні дані, кроки виконання та очікуваний результат.
...
У історії з’являється повідомлення користувача (вирівняне праворуч). З’являється відповідь бота: "Привіт! Чим можу допомогти?".

...
Вхід: Тема: "Підтримка"; Повідомлення: "Розкажи, будь ласка"
Очікуваний результат: Бот дає відповіді з пулу «Підтримка» (ввічливі/підтримуючі фрази).

## Скриншот:
<img width="811" height="583" alt="image" src="https://github.com/user-attachments/assets/5da97535-9aae-48c2-adec-efa252ce8e91" />
